<?php
//include('http://www.evanschambers.com/wordpress/wp-blog-header.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <section id="hungry" class="container-fluid">
    ...
    <section id="quote" class="container-fluid">
      <div class="row">
              ...
              <blockquote>Evans and Chambers consistently delivers on its promise to provide quality service to its customers. Its professional staff has been a critical part of our office’s success... </blockquote>
