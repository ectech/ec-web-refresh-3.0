...
<body id="aboutus" class="ectext">
    ...
    <?php include 'includes/header.php'; echoNavigation("What's your zeal?"); ?>
  
  <div id="content">
  
  <!-- Job listings -->
  <section id="joblistings" class="container-fluid" style="padding-top:50px;">
      <div class="row">
          <h1 style="color:#333;">Move your career forward: browse our job listings.</h1>
      ...
      <div class="row">
        <p class="col-sm-8">Big Data Engineer, TS with poly required. Chantilly, VA</p>
        <p class="col-sm-4">Information Technology</p>
      </div>

      <div class="row">
        <p class="col-sm-8">Data Correlation Engineer - TS/SCI with poly required.<br/>Chantilly, VA.</p>
        <p class="col-sm-4">Information Technology</p>
      </div>

      <div class="row">
        <p class="col-sm-8">Database Developer</p>
        <p class="col-sm-4">Information Technology</p>
      </div>

      <div class="row">
        <p class="col-sm-8">Database Engineer - ETL</p>
        <p class="col-sm-4">Information Technology</p>
      </div>

      <div class="row">
        <p class="col-sm-8">Deputy Program Manager</p>
        <p class="col-sm-4">Information Technology</p>
      </div>

      <div class="row">
        <p class="col-sm-8">InfoSec Systems Engineer</p>
        <p class="col-sm-4">Information Technology</p>
      </div>
